...
#Game Introduction:
    ...
    file=open('D:/School/Year 11/Python/Year 11 - Term 1 Assessment - 2025/Save Files/Player List/Player Name.txt','a')
...
#Medium Difficulty:
        ...
        print()
        print(colour.cyan+'You have Chosen '+colour.yellow+'Medium'+colour.cyan+' Difficulty!'+colour.end)
        print()
        print(colour.cyan+colour.under_line+'<-----'+colour.yellow+'Medium Difficulty Breif:'+colour.cyan+'----->'+colour.end)
        print()
        print(colour.yellow+'- You will Unscramble 6/7 Letter Words.'+colour.end)
        print(colour.yellow+'- You Start with 100 Points.'+colour.end)
        print(colour.yellow+'- You get 5 Attempts.'+colour.end)
        print(colour.yellow+'- You have an Option to choose 1 Hint on Each Question.'+colour.end)
        print(colour.yellow+'- If You try to get more than 1 Hint, You will Lose 10 Points.'+colour.end)
        print(colour.yellow+'- Each Correct Guess Earns 20 Points.'+colour.end)
        print(colour.yellow+'- Each Incorrect Guess Loses 10 Points.'+colour.end)
        print(colour.yellow+'- Each Incorrect Guess Loses 1 Attempt.'+colour.end)
        print(colour.yellow+'- You can Skip Questions but You Lose 10 Points.'+colour.end)
        print()
        print(colour.blue+'Get as Far as You can!'+colour.end)
        print(colour.blue+"Good Luck, Let's Go!"+colour.end)
        print()
        ...
        while attempts_medium_difficulty>0:
            ...
            print()
            print(colour.cyan+'<-----Score: '+colour.blue+'{}'.format(score)+colour.cyan+'----->'+colour.end)
            print(colour.cyan+'<-----Attempts Left: '+colour.blue+'{}'.format(attempts_medium_difficulty)+colour.cyan+'----->'+colour.end)
            print(colour.cyan+'<-----Skip: '+colour.blue+"(Type 'Skip')"+colour.cyan+'----->'+colour.end)
            print(colour.cyan+'<-----Hint: '+colour.blue+"(Type 'Hint')"+colour.cyan+'----->'+colour.end)
            print()
...
file=open('D:/School/Year 11/Python/Year 11 - Term 1 Assessment - 2025/Save Files/Latest Game Session/Player Name.txt','w')
file=file.write(game_player_name)
file=open('D:/School/Year 11/Python/Year 11 - Term 1 Assessment - 2025/Save Files/Latest Game Session/Difficulty Played.txt','w')
file=file.write(game_difficulty_name)
file=open('D:/School/Year 11/Python/Year 11 - Term 1 Assessment - 2025/Save Files/Latest Game Session/Final Score.txt','w')
file=file.write(score)
file=open('D:/School/Year 11/Python/Year 11 - Term 1 Assessment - 2025/Save Files/Latest Game Session/Words Guessed.txt','w')
file=file.write(game_words_guessed)
file=open('D:/School/Year 11/Python/Year 11 - Term 1 Assessment - 2025/Save Files/High Score.txt','r')
file=file.read()
file=str(file)
high_score=file
...
if high_score<score:
    ...
    file=open('D:/School/Year 11/Python/Year 11 - Term 1 Assessment - 2025/Save Files/High Score.txt','w')
    file=file.write(score)
else:
    print()
